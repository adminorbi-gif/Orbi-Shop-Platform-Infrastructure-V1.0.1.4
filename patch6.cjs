...
const targetMobile3 = `            <div className="flex items-center gap-1.5 shrink-0 ml-2">
              <button
...
const replacementMobile3 = `            <div className="flex items-center gap-1.5 shrink-0 ml-2">
              <button
...
if (content.includes(targetMobile3)) {
  content = content.replace(targetMobile3, replacementMobile3);
} else {
  console.log("targetMobile3 not found");
}
