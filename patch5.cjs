...
const targetMobile2 = `            <div className="flex items-center gap-1.5 shrink-0 ml-2">
              <button
...
const replacementMobile2 = `            <div className="flex items-center gap-1.5 shrink-0 ml-2">
              <button
...
if (content.includes(targetMobile2)) {
  content = content.replace(targetMobile2, replacementMobile2);
} else {
  console.log("targetMobile not found again");
}
